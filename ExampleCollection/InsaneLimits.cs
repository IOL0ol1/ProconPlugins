...
namespace PRoConEvents
{
    ...
    public class InsaneLimits : PRoConPluginAPI, IPRoConPluginInterface, PluginInterface
    {
        ...
        public Dictionary<string, PlayerInfoImpl> players;
        ...
        public InsaneLimits()
        {
            try
            {
                players = new Dictionary<string, PlayerInfoImpl>();
        ...
        public class Limit : LimitInfoInterface
        {
            ...
            public void RecordActivation(String PlayerName)
            {
                ...
                PlayerInfoImpl player = plugin.players[PlayerName];
    ...
    ""micovery you were banned for suspicious stats: Kpm: 0.4, Spm: 120, Kdr: 0.61""
      ...
      <h2> In-Game Commands</h2>
       ...
       <br />
        ...
        Dictionary<String, PlayerInfoImpl> new_players_batch = new Dictionary<string, PlayerInfoImpl>();
                ...
                while (true)
                {
                    ...
                    while (GetQCount() > 0)
                    {
                        ...
                        if (ck)
                        {
                            ...
                            PlayerInfoImpl ptmp = plugin.blog.fetchStats(new PlayerInfoImpl(plugin, info));
                    ...
                    List<PlayerInfoImpl> inserted = new List<PlayerInfoImpl>();
                    ...
                    lock (players_mutex)
                    {
                        ...
                        foreach (KeyValuePair<String, PlayerInfoImpl> pair in new_players_batch)
                    ...
                    if (bb > 0)
                    {
                        ...
                        foreach (PlayerInfoImpl pp in inserted)
                        {
...
#pragma warning restore
        ...
        public bool evaluateLimit(Limit limit, PlayerInfoImpl killer, KillInfo kill, PlayerInfoImpl victim)
        {
        ...
        public bool evaluateLimit(Limit limit, PlayerInfoImpl player, KillInfo kill)
        {
            return executeLimitAction(
                                            limit,
                                            player,
        ...
        public bool evaluateLimit(Limit limit, PlayerInfoImpl player)
        {
            return executeLimitAction(
                                            limit,
                                            player,
        ...
        public PlayerInfoInterface DummyPlayer()
        {
            ...
            dummy = new PlayerInfoImpl(this, pinfo);
        ...
        public void ResetPlayerSprees(BaseEvent type, PlayerInfoImpl player, PlayerInfoImpl killer, PlayerInfoImpl victim, Kill info)
        {
        ...
        public void evaluateLimitsForEvent(BaseEvent type, PlayerInfoImpl player, PlayerInfoImpl killer, PlayerInfoImpl victim, Kill info)
        {
        ...
        public void UpdateStats(PlayerInfoImpl killer, PlayerInfoImpl victim, BaseEvent type, Kill info, String weapon)
        {
            try
            {
        ...
        public void ListStatCmd(String sender, String scope)
        {
            ...
            PlayerInfoImpl sinfo = players[sender];

            //use reflection to go through the properties and find all the ones in the current scope
            PropertyInfo[] properties = typeof(PlayerInfoImpl).GetProperties();
        ...
        public void OneStatCmd(String sender, String prefix, String player, String scope, String type)
        {
            ...
            PlayerInfoImpl pinfo = players[new_player];
        ...
        public void OnPlayerJoin(PlayerInfoImpl player)
        {
            if (player == null)
                return;
        ...
        public override void OnPlayerKilled(Kill info)
        {
            ...
            try
            {
                ...
                PlayerInfoImpl vpinfo = null;
                PlayerInfoImpl kpinfo = null;
        ...
        public void RoundOverReset()
        {
            ...
            foreach (KeyValuePair<String, PlayerInfoImpl> pair in players)
                if (pair.Value != null)
                {
        ...
        private void playerStatsDumpCmd(String sender, String level, String scope, String player)
        {
            ...
            PlayerInfoImpl pinfo = players[player];
        ...
        {
            PlayerInfoImpl left = null;
            PlayerInfoImpl right = null;
        ...
        public bool EABanPlayerWithMessage(EABanType type, EABanDuration duration, String name, int minutes, string message)
        {
            ...
            PlayerInfoImpl player = players[name];
    ...
    public class BattleLog
    {
        ...
        public PlayerInfoImpl fetchStats(PlayerInfoImpl pinfo)
        {
            try
            {
                bool directFetchEnabled = plugin.getBooleanVarValue("use_direct_fetch");
        ...
        public List<BattlelogWeaponStats> extractWeaponStats(PlayerInfoImpl pinfo, String personaId)
        {
        ...
        public void extractBasicFields(Hashtable stats, PlayerInfoImpl pinfo)
        {
            try
            {
                if (stats == null)
        ...
        public void extractClanTag(String result, PlayerInfoImpl pinfo)
        {
            /* Extract the player tag */
        ...
        public void extractKitTimes(Hashtable table, Dictionary<String, String> id2kit, PlayerInfoImpl pinfo, String suffix)
        {
            if (suffix != null)
            {
    ...
    {
        public InsaneLimits plugin = null;
        public Dictionary<String, PlayerInfoImpl> _players = null;
        ...
        public List<PlayerInfoInterface> players
        {
            get
            {
                return (new List<PlayerInfoImpl>(_players.Values)).ConvertAll<PlayerInfoInterface>
                        (new Converter<PlayerInfoImpl, PlayerInfoInterface>
                            (
                              delegate (PlayerInfoImpl p) { return (PlayerInfoInterface)p; }
                            )
                        );
            }
        }
        ...
        public double Aggregate(String property_name)
        {
            ...
            foreach (KeyValuePair<String, PlayerInfoImpl> pair in _players)
                dict.Add(pair.Key, (Object)pair.Value);

            return plugin.Aggregate(property_name, typeof(PlayerInfoImpl), dict);
        }

        public TeamInfo(InsaneLimits plugin, int TeamId, Dictionary<String, PlayerInfoImpl> players, ServerInfo server)
        {
            this.plugin = plugin;
            this._TeamId = TeamId;

            _players = new Dictionary<string, PlayerInfoImpl>();
    ...
    public class PlayerInfoImpl : PlayerInfoInterface
    {
        ...
        public PlayerInfoImpl(InsaneLimits plugin, CPunkbusterInfo pbInfo)
        {
            this.pbInfo = pbInfo;
            this.plugin = plugin;
        ...
        public void teamKilled(PlayerInfoImpl victim, Kill kinfo)
        {
        }
